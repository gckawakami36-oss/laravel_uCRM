                                ...
                                <div class="container px-5 py-8 mx-auto">
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="flex flex-wrap -m-2">
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <div class="flex items-center space-x-4 mt-2">
                                                        <label class="inline-flex items-center">
                                                            <input type="radio" name="gender" value="0" v-model="form.gender" class="form-radio text-indigo-600">
                                                            <span class="ml-2">男性</span>
                                                        </label>
                                                        <label class="inline-flex items-center">
                                                            <input type="radio" name="gender" value="1" v-model="form.gender" class="form-radio text-indigo-600">
                                            ...
                                            <div class="p-2 w-full">
                                                <Link :href="route('customers.index')" class="flex mx-auto text-indigo-500 border-0 py-2 focus:outline-none hover:text-indigo-600 rounded text-lg">戻る</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
